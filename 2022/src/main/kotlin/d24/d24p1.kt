...
data class Blizzard(val row: Int, val col: Int, val facing: Facing)
fun main() {
    ...
    toVisit.add(State(start.first, start.second, 0, listOf()))
    ...
    while(toVisit.isNotEmpty()) {
        ...
        if (visiting.steps+1 !in blizzardsByMinute.keys) blizzardsByMinute[visiting.steps+1] = advanceBlizzards(blizzardsByMinute[visiting.steps]!!)
