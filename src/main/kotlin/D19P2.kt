...
fun inBeam(it: Pair<Int, Int>): Boolean {
    return runProgramFromFile("src/main/resources/d19p1", listOf(it.first.toLong(), it.second.toLong()))[0] == 1L
}
...
fun fits(topleft: Pair<Int, Int>): Boolean {
    ...
    return runProgramFromFile("src/main/resources/d19p1", listOf(x, y + 99))[0] == 1L
            && runProgramFromFile("src/main/resources/d19p1", listOf(x + 99, y))[0] == 1L
}
